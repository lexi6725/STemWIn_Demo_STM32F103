...
{ 
	...
	/* Check if the LCD is R61505U Controller */
	...
	LCD_WriteReg(LCD_REG_48, 0x0007);	//0x0006
	LCD_WriteReg(LCD_REG_49, 0x0007);	//0x0101
	LCD_WriteReg(LCD_REG_50, 0x0007);	//0x0003
	LCD_WriteReg(LCD_REG_53, 0x0007);	//0x0106
	LCD_WriteReg(LCD_REG_54, 0x0007);	//0x0b02
	LCD_WriteReg(LCD_REG_55, 0x0700);	//0x0302
	LCD_WriteReg(LCD_REG_56, 0x0700);	//0x0707
	LCD_WriteReg(LCD_REG_57, 0x0700);	//0x0007
	LCD_WriteReg(LCD_REG_60, 0x0700);	//0x0600
	LCD_WriteReg(LCD_REG_61, 0x1F00);	//0x020b
...
void LCD_WindowModeDisable(void)
{
  ...
  if(LCD_ReadReg(0x00) == LCD_R65105U)
  {
